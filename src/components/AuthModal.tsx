...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-900/95 backdrop-blur-md flex flex-col justify-center items-center px-4 py-8">
      
      {/* Top Back Navigation */}
      <div className="max-w-md w-full mb-6">
        <button
          onClick={onBackToLanding}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-800 text-slate-300 hover:text-white hover:bg-slate-700 transition-colors text-xs font-semibold border border-slate-700"
        >
      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-200">
        ...
        {/* Header Banner */}
        <div className="p-8 text-white bg-gradient-to-r from-emerald-900 via-emerald-800 to-teal-900">
          <div className="flex items-center justify-between mb-4">
            <img 
              src="https://lh3.googleusercontent.com/u/0/d/1Vq1r0DLsLGgotHmTHZi9bH4W-DUf4pVz" 
              alt="MSSN Logo" 
              className="w-14 h-14 object-contain shrink-0 rounded-xl drop-shadow-md" 
          ...
          <h2 className="text-2xl font-extrabold font-serif">
            {isAttendance ? 'Attendance Portal Access' : 'Financial Records Access'}
          </h2>
          <p className="text-xs opacity-90 mt-1">
            {isAttendance 
              ? 'Log in or sign up as Attendance Secretary / Officer to manage sheets.' 
              : 'Log in or sign up as Financial Secretary / Accountant to view & upload records.'}
          </p>
        </div>
