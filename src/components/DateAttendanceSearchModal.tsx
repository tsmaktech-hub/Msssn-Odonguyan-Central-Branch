          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <input
                ...
                className="px-3 py-1.5 sm:py-2 rounded-xl bg-white border border-slate-300 text-xs sm:text-sm font-bold text-slate-800 focus:ring-2 focus:ring-emerald-500 outline-none shadow-2xs"
              />
            </div>
            ...
            {availableDates.length > 0 && (
              <div className="flex items-center gap-1.5 overflow-x-auto pb-1 max-w-full no-scrollbar">
                <span className="text-[10px] sm:text-[11px] font-semibold text-slate-500 shrink-0">Dates:</span>
