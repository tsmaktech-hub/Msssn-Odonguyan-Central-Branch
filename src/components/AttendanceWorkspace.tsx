  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <img 
                ...
                alt="MSSN Logo" 
                className="w-12 h-12 sm:w-14 sm:h-14 object-contain shrink-0 rounded-xl drop-shadow" 
                referrerPolicy="no-referrer"
              />
              <div>
                <h1 className="text-base font-extrabold leading-tight font-serif text-white">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex flex-col text-right">
              <span className="text-xs text-emerald-200">Logged in Officer</span>
            ...
            <button
              onClick={onLogout}
              className="px-3 py-1.5 rounded-xl bg-emerald-800 hover:bg-red-700 text-emerald-100 hover:text-white transition-colors text-xs font-bold flex items-center gap-1.5 border border-emerald-700/50"
            >
      ...
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-6">
        ...
        {/* Sync Toast Alert */}
        {showSyncToast && (
          <div className="fixed bottom-6 right-6 z-50 bg-slate-900 text-white px-5 py-4 rounded-2xl shadow-2xl border-2 border-emerald-500 flex items-center gap-3 animate-bounce">
            <div className="w-10 h-10 rounded-xl bg-emerald-500 text-white flex items-center justify-center font-bold">
              <CheckCircle2 className="w-6 h-6" />
            </div>
            <div>
              <p className="font-bold text-sm text-emerald-300">Attendance Sheet Synced!</p>
        ...
        <div className="bg-gradient-to-r from-emerald-800 via-teal-800 to-emerald-950 rounded-3xl p-6 text-white shadow-xl border border-emerald-700 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-1">
            ...
            <h2 className="text-xl sm:text-2xl font-extrabold tracking-tight font-serif">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-amber-400 hover:bg-amber-300 text-emerald-950 font-bold text-xs flex items-center gap-2 shadow-lg transition-transform transform active:scale-95"
            >
              <RotateCcw className="w-4 h-4" />
              Start New Season / Reset Sheet
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          
          {/* SYNC ATTENDANCE SHEET BUTTON */}
          <button
            onClick={handleSyncClick}
            className="w-full sm:w-auto px-6 py-3 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-extrabold text-sm shadow-lg shadow-emerald-600/30 flex items-center justify-center gap-2.5 transition-transform transform active:scale-95"
          >
            <RefreshCw className="w-5 h-5 animate-spin-slow" />
            <span>Sync Attendance Sheet</span>
            {lastSync && (
              <span className="text-xs font-normal opacity-80 border-l border-emerald-400/40 pl-2">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            ...
            <button
              ...
              className="flex-1 sm:flex-initial px-4 py-2.5 rounded-2xl bg-emerald-50 hover:bg-emerald-100 text-emerald-800 font-bold text-xs border border-emerald-300 flex items-center justify-center gap-2 transition-colors"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs border border-slate-300 flex items-center justify-center gap-2 transition-colors"
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <select
              ...
              className="px-4 py-2 rounded-2xl bg-slate-50 border border-slate-300 font-semibold text-slate-800 text-xs focus:ring-2 focus:ring-emerald-500 outline-none"
            >
              {programs.map(prog => (
        ...
        <div className="bg-white rounded-3xl shadow-md border border-slate-200 overflow-hidden">
          ...
          <div className="grid grid-cols-3 bg-slate-100 p-2 border-b border-slate-200">
            ...
            <button
              ...
              className={`py-3.5 px-4 rounded-2xl font-extrabold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all ${
            ...
            >
              <Users className="w-4 h-4" />
              <span>All Roster Directory</span>
              <span className={`ml-1 px-2 py-0.5 rounded-full text-xs font-bold ${
          ...
          <div className="p-4 sm:p-6 bg-slate-50 border-b border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                placeholder="Search member name, phone, reg no..."
                className="w-full pl-10 pr-4 py-2 rounded-xl bg-white border border-slate-300 text-xs focus:ring-2 focus:ring-emerald-500 outline-none"
              />
            </div>
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              >
                <option value="all">All Member Categories</option>
              ...
              <button
                ...
                className="px-3 py-2 rounded-xl bg-emerald-100 hover:bg-emerald-200 text-emerald-800 text-xs font-bold border border-emerald-300 shrink-0"
              >
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-100/80 text-slate-600 text-xs uppercase font-bold tracking-wider border-b border-slate-200">
                  ...
                  <th className="py-3.5 px-4">Notes / Paid Dues</th>
